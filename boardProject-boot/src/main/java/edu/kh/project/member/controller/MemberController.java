...
public class MemberController {
	...
	/** 로그인
	 * @param inputMember : 커맨드 객체(@ModelAtrribute 생략)
	 *                      (memberEmail, memberPw 세팅된 상태)
	 * @param ra : 리다이렉트 시 request scope로 데이터를 전달하는 객체
	 * @param model : 데이터 전달용 객체(기본 request scopte)
	 * @return "redirect:/"
	 */
	@PostMapping("login")
	 ...
	 * @param status : 세연을 완료(없앰) 시키는 역할의 객체
	 * 		- @SessionAttirubtes 로 등록된 세션을 만료
	 *      - 서버에서 기본 세션 객체가 사라짐과 동시에
